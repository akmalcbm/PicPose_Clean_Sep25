...
class HomeRepository {
    ...
    fun getMockAIPrompts(): List<AIPrompt> = listOf(
        ...
        AIPrompt(
            ...
            fullPrompt = "Professional studio photography setup with two subjects in a modern film studio. Cinematic lighting with softbox lights, professional camera equipment visible in background. Green screen backdrop with studio lighting setup. One person in formal business attire with tie, another in leather jacket. Professional photography studio environment with high-end equipment, studio lights, and clean modern aesthetic. Shot with professional camera settings, shallow depth of field, studio lighting.",
            imageUrl = "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600",
            category = "Studio",
            tags = listOf("studio", "professional", "cinematic", "lighting"),
            likes = 189,
            isPopular = true
        ),
        AIPrompt(
