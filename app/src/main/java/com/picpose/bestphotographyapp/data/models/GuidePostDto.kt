...
fun GuidePostDto.toGuidePost(baseUrl: String? = null): GuidePost {
    ...
    return GuidePost(
        ...
        image = imageResolved,
        imageUrl = imageResolved,          // populate alias field
        thumbnailUrl = imageResolved,      // use same image for thumbnail
        category = category ?: "",
        tags = parsedTags,
        difficultyLevel = difficulty_level ?: "",
        estimatedReadTime = anyToInt(estimated_read_time, default = 0),
        readingTime = anyToInt(estimated_read_time, default = 0), // populate alias field
        likes = likes,
        favorites = favorites,
        views = views,
        viewCount = views,                 // populate alias field
        ...
        author = author ?: "",
        authorName = author ?: "",         // populate alias field
        authorId = author_id ?: "",
